...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-void">
      ...
      <Link href="/familytree" className="px-6 py-3 border border-white/20 hover:border-white/50 text-white text-xs tracking-[0.2em] uppercase transition-colors">
        Return to Sacred Family Tree
      </Link>
    </div>
  );
}
